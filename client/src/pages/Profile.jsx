  ...
  return (
    <div className='p-3 max-w-lg mx-auto ' >
     ...
     <form onSubmit={handleSubmit} action="" className='flex flex-col gap-4'>
      ...
      <Link className='bg-blue-700 text-white rounded-lg p-3 uppercase text-center hover:opacity-80' to={"/create-listing"}>Create Listing</Link>
     </form>
     ...
     <p className='text-green-700 mt-5'>
      ...
      <button onClick={handleShowListings} className='text-blue-700 w-full'> Showing Listings</button>
      ...
      {userListings.map((listing) =>(
        <div key={listing._id} className='border rounded-lg p-3 flex justify-between items-center gap-4'>
          ...
          <div className='flex flex-col item-center'>
            ...
            <button  className='text-blue-700 uppercase'>Edite</button>
